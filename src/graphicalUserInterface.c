...
void textBox_render(textBox textBox, SDL_Renderer *renderTarget)
{
   ...
   SDL_Rect boxRect = {32 * SCREEN_SCALE, 160 * SCREEN_SCALE, 192 * SCREEN_SCALE, 64 * SCREEN_SCALE};
   ...
   while(index < textBox.size)
   {
      ...
      if(column > MAX_TEXT_WIDTH - 1)
      {
         ...
         SDL_Rect textRect = {37 * SCREEN_SCALE, rows * 48 + 162 * SCREEN_SCALE, 176 * SCREEN_SCALE, 16 * SCREEN_SCALE};
